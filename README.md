...
def calculate_demographic_data(print_data=True):
    ...
    # How many of each race are represented in this dataset? (Pandas series with race names as index labels)
    ...
    if '>50K' in country_stats.columns:
        highest_earning_country_percentage_series = country_stats['>50K'] * 100
